...
import sys
from models.ALBEF_model import ALBEFModel
from models.CLIP_model import ClipModel
from models.Vilt_model import ViltModel
...
def main():
    ...
    print("Skipping ALBEF model for now as that requires additional config files")
