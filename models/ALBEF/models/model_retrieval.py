...
class ALBEF(nn.Module):
    def __init__(self, config):
        ...
        self.text_encoder = BertModel(config=bert_config, add_pooling_layer=False) #UNCOMMENT FOR RANDOM!!
        ...
        if self.distill:
            ...
            self.text_encoder_m = BertModel.from_pretrained('bert-base-uncased', config=bert_config, add_pooling_layer=False)
    ...
    def similarity_and_matching(self, image, text, pairwise=False) -> Dict:
        ...
        hidden_states = {'txt': text_hidden_states[1:], 'multi_old': multi_hidden_states[1:]}
